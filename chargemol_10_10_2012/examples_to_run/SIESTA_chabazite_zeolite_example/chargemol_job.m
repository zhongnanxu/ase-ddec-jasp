...
input_type=3 % whether the input file is: (1) gaussian cube file format, (2) VASP format, (3) XSF format, (4) CP2K cube file format, (5) WFX format
...
% 
xsf_inputfile='chabazite.XSF' % Example of how to change input file name if you want to; otherwise program uses valence_density.xsf.
