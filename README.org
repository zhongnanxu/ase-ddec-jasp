...
To use this module, do either one of two things. Alter the ase-ddec-jasp module file to make the DDEC_PATH point to the directory that holds the chargemol_10_10-2012 folder, and have PYTHONPATH and DDEC_SCRIPT point to this folder.  Or, addd these three lines to your .bashrc file.
